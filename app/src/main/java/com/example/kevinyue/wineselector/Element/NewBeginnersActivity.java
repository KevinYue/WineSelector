...
public class NewBeginnersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_beginners);

        this.setTitle("New Beginners Wine List");

        // jsonParser a method to control the json data
        jsonParser();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_elementactivity:
                Intent elementIntent = new Intent(NewBeginnersActivity.this, ElementsActivity.class);
                startActivity(elementIntent);
                return true;
            case R.id.action_foodactivity:
                Intent foodIntent = new Intent(NewBeginnersActivity.this, FoodListActivity.class);
                startActivity(foodIntent);
                return true;
            case R.id.action_redactivity:
                Intent redIntent = new Intent(NewBeginnersActivity.this, RedWineActivity.class);
                startActivity(redIntent);
                return true;
            case R.id.action_whiteactivity:
                Intent whiteIntent = new Intent(NewBeginnersActivity.this, WhiteWineActivity.class);
                startActivity(whiteIntent);
                return true;
            case R.id.action_roseactivity:
                Intent RoseIntent = new Intent(NewBeginnersActivity.this, RoseWineActivity.class);
                startActivity(RoseIntent);
                return true;
            case R.id.action_sparklingactivity:
                Intent sparklingIntent = new Intent(NewBeginnersActivity.this, SparklingWineActivity.class);
                startActivity(sparklingIntent);
                return true;
            case R.id.action_searchactivity:
                Intent searchIntent = new Intent(NewBeginnersActivity.this, SearchWineActivity.class);
    ...
    public void jsonParser() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Log.d("Beginners ", tempWine.getName());

                if(tempWine.getName().equals("Santenay 2000") || tempWine.getName().equals("Zonnebloem Sauvignon Blanc 2004"))
        ...
        listView = (ListView) findViewById(R.id.beginnersList);
