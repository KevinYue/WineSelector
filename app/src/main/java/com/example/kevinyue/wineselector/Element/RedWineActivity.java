...
public class RedWineActivity extends AppCompatActivity{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_elementactivity:
                Intent elementIntent = new Intent(RedWineActivity.this, ElementsActivity.class);
                startActivity(elementIntent);
                return true;
            case R.id.action_foodactivity:
                Intent foodIntent = new Intent(RedWineActivity.this, FoodListActivity.class);
                startActivity(foodIntent);
                return true;
            case R.id.action_whiteactivity:
                Intent whiteIntent = new Intent(RedWineActivity.this, WhiteWineActivity.class);
                startActivity(whiteIntent);
                return true;
            case R.id.action_roseactivity:
                Intent RoseIntent = new Intent(RedWineActivity.this, RoseWineActivity.class);
                startActivity(RoseIntent);
                return true;
            case R.id.action_sparklingactivity:
                Intent sparklingIntent = new Intent(RedWineActivity.this, SparklingWineActivity.class);
                startActivity(sparklingIntent);
                return true;
            case R.id.action_newactivity:
                Intent beginnersIntent = new Intent(RedWineActivity.this, NewBeginnersActivity.class);
                startActivity(beginnersIntent);
                return true;
            case R.id.action_searchactivity:
                Intent searchIntent = new Intent(RedWineActivity.this, SearchWineActivity.class);
    ...
    public void jsonParser() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if(tempWine.getType().equals("red"))
        ...
        listView = (ListView) findViewById(R.id.redList);
    ...
    /*private void findViewsById(View view) {
        ...
        listView = (ListView) view.findViewById(R.id.redList);
    }*/
}
