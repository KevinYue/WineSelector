...
public class FoodListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Food For Wine List");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_elementactivity:
                Intent elementIntent = new Intent(FoodListActivity.this, ElementsActivity.class);
                startActivity(elementIntent);
                return true;
            case R.id.action_redactivity:
                Intent redIntent = new Intent(FoodListActivity.this, RedWineActivity.class);
                startActivity(redIntent);
                return true;
            case R.id.action_whiteactivity:
                Intent whiteIntent = new Intent(FoodListActivity.this, WhiteWineActivity.class);
                startActivity(whiteIntent);
                return true;
            case R.id.action_roseactivity:
                Intent RoseIntent = new Intent(FoodListActivity.this, RoseWineActivity.class);
                startActivity(RoseIntent);
                return true;
            case R.id.action_sparklingactivity:
                Intent sparklingIntent = new Intent(FoodListActivity.this, SparklingWineActivity.class);
                startActivity(sparklingIntent);
                return true;
            case R.id.action_newactivity:
                Intent beginnersIntent = new Intent(FoodListActivity.this, NewBeginnersActivity.class);
                startActivity(beginnersIntent);
                return true;
            case R.id.action_searchactivity:
                Intent searchIntent = new Intent(FoodListActivity.this, SearchWineActivity.class);
    ...
    public void jsonParser() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if(tempWine.getType().equals("white") || tempWine.getType().equals("red"))
