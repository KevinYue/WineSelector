...
public class RoseWineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rose_wine);

        // Set title
        this.setTitle("Rose Wine List");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_elementactivity:
                Intent elementIntent = new Intent(RoseWineActivity.this, ElementsActivity.class);
                startActivity(elementIntent);
                return true;
            case R.id.action_foodactivity:
                Intent foodIntent = new Intent(RoseWineActivity.this, FoodListActivity.class);
                startActivity(foodIntent);
                return true;
            case R.id.action_redactivity:
                Intent redIntent = new Intent(RoseWineActivity.this, RedWineActivity.class);
                startActivity(redIntent);
                return true;
            case R.id.action_whiteactivity:
                Intent whiteIntent = new Intent(RoseWineActivity.this, WhiteWineActivity.class);
                startActivity(whiteIntent);
                return true;
            case R.id.action_sparklingactivity:
                Intent sparklingIntent = new Intent(RoseWineActivity.this, SparklingWineActivity.class);
                startActivity(sparklingIntent);
                return true;
            case R.id.action_newactivity:
                Intent beginnersIntent = new Intent(RoseWineActivity.this, NewBeginnersActivity.class);
                startActivity(beginnersIntent);
                return true;
            case R.id.action_searchactivity:
                Intent searchIntent = new Intent(RoseWineActivity.this, SearchWineActivity.class);
    ...
    public void jsonParser() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if(tempWine.getType().equals("rose"))
        ...
        listView = (ListView) findViewById(R.id.roseList);
